...
#
# screen -d -m ./20190228_betaSSS_abc_R_sigma_R_disl_dosl_scan.sh > 20190228_betaSSS_abc_R_sigma_R_disl_dosl_scan.log
...
# -> use 1 to 3 platelet thicknesses 

# R=22.0:0.5:23.0, dR=0.5,1.0, dosl=disl=12,16,20 with dtot=32
...
jobname="SSS_180x360_P${disl_str2}_${dosl_str2}_ST_${D_str2}_${dR_str2}_N50_OSL_SPST_123"
echo $jobname
