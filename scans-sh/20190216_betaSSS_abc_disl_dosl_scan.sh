...
#
# screen -d -m ./20190216_betaSSS_abc_disl_dosl_scan.sh > 20190216_betaSSS_abc_disl_dosl_scan.log
...
jobname="SSS_180x360_P${disl_str2}_${dosl_str2}_ST_340_030_N50_OSL_SMALLER"
...
echo "" >> $output
echo "$XNDiff -l -openmp +o $jobname -X +cif betaSSS_abc.cif cif_core.dic -sym symop_betaSSS_abc.txt +av 0 0.0 90.0 0.5 0.0 360.0 1.0 -sin -init_n_rand -10112 -conc def -distr +par $disl_str $dosl_str 310.0 350.0 333.0 +f stackcpp 141.4 28.3 106.1 21.2 2.522 0.382 0.0 20.0 0.0 20.0 36.0 4.0 0 1 0 0.001 0.45 450 50 0 0 1 0 0 1 7 1 -silent -z 10 -conv 0" >> $output
echo "" >> $output
echo "cd out/" >> $output
