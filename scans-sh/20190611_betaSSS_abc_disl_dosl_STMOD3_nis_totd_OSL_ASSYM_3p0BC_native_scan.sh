...
#
# screen -d -m ./20190611_betaSSS_abc_disl_dosl_STMOD3_nis_totd_OSL_ASSYM_3p0BC_native_scan.sh > 20190611_betaSSS_abc_disl_dosl_STMOD3_nis_totd_OSL_ASSYM_3p0BC_native_scan.log
...
jobname="SSS_180x360_P${disl_str2}_${dosl_str2}_STMOD3_nis_totd_N50_OSL_ASSYM_3p0BC_native"
echo $jobname
...
echo "" >> $output
echo "$XNDiff -l -openmp +o $jobname -X +cif betaSSS_abc.cif cif_core.dic -sym symop_betaSSS_abc.txt -nis 0.419961 0.107985 0.302641 0.108923 0.045875 0.014615 +av 0 0.0 90.0 0.5 0.0 360.0 1.0 -sin -init_n_rand -10112 -conc def -distr +par $disl_str $dosl_str 310.0 350.0 333.0 +f stackcpp 400.0 100.0 120.0 40.0 0.0 0.0 0.0 50 0.0 20.0 0.0 0.0 0 2 3 0.001 0.45 450 50 0 0 1 0 0 1 6 5 -silent" >> $output
echo "" >> $output
echo "cd out/" >> $output
