...
#
# screen -d -m ./20190322_betaSSS_abc_disl_dosl_scan_ASSYM.sh > 20190322_betaSSS_abc_disl_dosl_scan_ASSYM.log
...
jobname="SSS_180x360_P${disl_str2}_${dosl_str2}_ST_360_400_N50_OSL_ASSYM"
...
cd out/
tar cfvz $jobname.tar.gz --exclude=*.tar.gz $jobname* --remove-files
cd ../
