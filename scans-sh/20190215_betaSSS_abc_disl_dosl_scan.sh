...
#
# screen -d -m ./20190215_betaSSS_abc_disl_dosl_scan.sh > 20190215_betaSSS_abc_disl_dosl_scan.log
...
jobname="SSS_180x360_P${disl_str2}_${dosl_str2}_ST_340_030_N50_OSL_LARGER"
