...
#
# screen -d -m ./20190327_betaSSS_abc_disl_dosl_scan_SMALLER.sh > 20190327_betaSSS_abc_disl_dosl_scan_SMALLER.log
...
jobname="SSS_180x360_P${disl_str2}_${dosl_str2}_ST_360_400_N50_OSL_SMALLER"
