...
#
# screen -d -m ./20190618_betaSSS_abc_disl_dosl_scan_ASSYM_symmshells.sh > 20190322_betaSSS_abc_disl_dosl_scan_ASSYM_symmshells.log
...
jobname="SSS_180x360_P${disl_str2}_${dosl_str2}_ST_360_400_N50_OSL_ASSYM_symmshells"
echo "$jobname.sh"
