...
#
# screen -d -m ./20190325_betaSSS_abc_disl_dosl_STMOD3_scan.sh > 20190325_betaSSS_disl_dosl_STMOD3_scan.log
...
jobname="SSS_180x360_P${disl_str2}_${dosl_str2}_STMOD3_N50_OSL"
echo $jobname
