...
#
# screen -d -m ./20190605_betaSSS_abc_disl_dosl_STMOD3_OSL_ASSYM_3p0BC_native_scan.sh > 20190605_betaSSS_abc_disl_dosl_STMOD3_OSL_ASSYM_3p0BC_native_scan.log
...
#
# more SSS_3p0BC_1to5dil_OSL_ASSYM_005/SSS_180x360_P012_040_ST_360_400_N50_OSL_ASSYM.log
# c1 = 0.26249759281607415
# c2 = 0.09872287568105395
# c3 = 0.36419901965372614
# c4 = 0.16257579386053717
# c5 = 0.0817375025739596
# c6 = 0.03026721541464894
...
jobname="SSS_180x360_P${disl_str2}_${dosl_str2}_STMOD3_N50_OSL_ASSYM_3p0BC_native"
echo $jobname
...
echo "" >> $output
echo "$XNDiff -l -openmp +o $jobname -X +cif betaSSS_abc.cif cif_core.dic -sym symop_betaSSS_abc.txt -cis 0.26249759281607415 0.09872287568105395 0.36419901965372614 0.16257579386053717 0.0817375025739596 0.03026721541464894 +av 0 0.0 90.0 0.5 0.0 360.0 1.0 -sin -init_n_rand -10112 -conc def -distr +par $disl_str $dosl_str 310.0 350.0 333.0 +f stackcpp 400.0 100.0 120.0 40.0 0.0 0.0 0.0 50 0.0 20.0 0.0 0.0 0 2 3 0.001 0.45 450 50 0 0 1 0 0 1 6 5 -silent" >> $output
echo "" >> $output
echo "cd out/" >> $output
