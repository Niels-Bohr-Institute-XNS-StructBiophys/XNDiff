...
#
# screen -d -m ./20190902_betaSSS_abc_disl_dosl_STMOD3_nis_totd_OSL_ASSYM_7p5BC_native_scan.sh > 20190902_betaSSS_abc_disl_dosl_STMOD3_nis_totd_OSL_ASSYM_7p5BC_native_scan.log
...
jobname="SSS_180x360_P${disl_str2}_${dosl_str2}_STMOD3_nis_totd_N50_OSL_ASSYM_7p5BC_native_v2"
echo $jobname
